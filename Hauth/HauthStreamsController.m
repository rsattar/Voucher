...
@interface HauthStreamsController () <NSStreamDelegate>
...
@implementation HauthStreamsController
...
- (void)sendData:(nonnull NSData *)data
{
    ...
    self.dataSendBuffer = [NSMutableData dataWithData:data];
